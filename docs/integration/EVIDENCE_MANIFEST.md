...
| WP-109 | True install/upgrade/rollback proof and release-manifest consistency on the final frozen release SHA. `EV-20260622-036` adds a draft current-candidate manifest and contract coverage, but it does not prove rollback/upgrade or final release readiness. |
