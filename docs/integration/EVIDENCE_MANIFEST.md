...
| WP-106 | Durable selected-reference provenance inspection for real PaperBananaBench data through a no-spend dry-run harness or approved Codex/provider run. |
