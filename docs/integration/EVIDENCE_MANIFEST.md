...
| WP-007 | Full manual keyboard navigation and VoiceOver traversal across Settings, reference rows, artifact grid context menus, disabled states, preflight sheets, and table workflows. `EV-20260622-021` covers table-selection AX summary proof, and `EV-20260622-027` covers Prompt Studio prompt-to-run-control keyboard escape. |
