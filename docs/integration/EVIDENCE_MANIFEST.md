...
| WP-106 | Approved live provider/fallback native E2E with non-private fixtures, spend limit, redacted request/metadata/provider-artifact review, and failure/recovery proof on the final candidate. `EV-20260622-038` covers no-spend native generation/refinement store artifact and provenance behavior only. |
