...
enum NativeImageGenerationDurableRunWriter {
    static func prepare(
        ...
        var payload: [String: Any] = [
            ...
            "reference_mode": request.referenceExamples.isEmpty ? "none" : "manual_native_prompt_enrichment",
            "reference_example_count": request.referenceExamples.count,
            "reference_examples": ReferenceExampleSelection.durablePayload(for: request.referenceExamples),
