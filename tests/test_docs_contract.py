...
def test_release_candidate_manifest_tracks_required_provenance_and_open_gates():
    required_phrases = [
        ...
        "Latest WP-106 current-head real Codex compile-skip evidence head",
        ...
        "Latest WP-108 release-candidate template source head",
        "19456ee01cf51828c36b92558042300e7394b2d9",
        ...
        "WP-108 release-candidate template",
        ...
        "f963f4d77b022a324e4aa2b5e5896122320c177c",
        ...
        "current-head compile/skip readiness",
        "result=Skipped",
        "totalTestCount=1",
        "skippedTests=1",
        "EV-20260623-097",
